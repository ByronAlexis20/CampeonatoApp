...
public class CategoriaLista {
	...
	public void buscar(){
		...
		if(categoria.size() == 0) {
			...
			for(int i=0; i<categoria.size(); i++) {
				if(categoria.get(i).getTipo().equals("F")) {
					categoria.get(i).setTipo("FEMENINO");					
				}else if (categoria.get(i).getTipo().equals("M")) {
					categoria.get(i).setTipo("MASCULINO");
				}
			}
	...
	public void nuevo(){
		...
		Window ventanaCargar = (Window) Executions.createComponents("/Mantenimiento/categorias/categoriaEditar.zul", null, null);
