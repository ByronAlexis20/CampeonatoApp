...
@Entity
@NamedQueries({
@NamedQuery(name="Configuracionjugador.findAll", query="SELECT c FROM Configuracionjugador c WHERE c.estado IS NULL"),
@NamedQuery(name="Configuracionjugador.buscarPorPatron", 
query="SELECT c FROM Configuracionjugador c WHERE LOWER(c.campeonato.nombreC) LIKE LOWER(:patron) ORDER BY c.idConfigJugadores DESC "),
