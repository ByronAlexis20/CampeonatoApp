...
@NamedQueries({
	...
	query="SELECT o FROM Opcionperfil o WHERE o.perfil.idPerfil = :perfil and o.opcion.url <> NULL"),
	
	@NamedQuery(name="Opcionperfil.opcionesHijos", 
	query="SELECT o FROM Opcionperfil o WHERE o.perfil.idPerfil = :perfil and o.estado IS NULL and o.opcion.url <> NULL"),
	
	@NamedQuery(name="Opcionperfil.BuscarOpcionMenuPerfilPadre", 
	query="SELECT o FROM Opcionperfil o WHERE o.perfil.idPerfil = :perfil and o.opcion.url <> NULL")
})
