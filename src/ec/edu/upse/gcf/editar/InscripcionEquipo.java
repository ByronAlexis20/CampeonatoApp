...
public class InscripcionEquipo {
	...
	private Detallecampeonato detcampeonato;
	...
	@Command
	@NotifyChange({"campeonato", "campeonatoSeleccionado"})
	public void tipoC() {
		if(campeonatoSeleccionado != null) {		
			for(Campeonato camp : campeonatoDao.getListaCampeonato()) {
				if( camp.getTipoCampeonato().equals("M")) {
					tipoCampeonato = "MASCULINO";
				}else if(camp.getTipoCampeonato().equals("F")){
					tipoCampeonato = "FEMENINO";
				}	
			}		
		}
	}
	...
	public Detallecampeonato getDetcampeonato() {
		return detcampeonato;
	}

	public void setDetcampeonato(Detallecampeonato detcampeonato) {
		this.detcampeonato = detcampeonato;
	}
}
