...
public class EquipojugadorDAO extends ClaseDAO {
	...
	public List<Equipojugador> getListaEquipojugadores() {
		List<Equipojugador> retorno = new ArrayList<Equipojugador>();
		Query query = getEntityManager().createNamedQuery("Equipojugador.findAll");
		query.setHint("javax.persistence.cache.storeMode", "REFRESH");
		retorno = (List<Equipojugador>) query.getResultList();		
		return retorno;
	}
}
